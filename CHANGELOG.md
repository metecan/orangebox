...
- New **OrangeBox Dark Plus** theme: merges VS Code Dark 2026 background/panel colors (`#121314` editor, `#191A1B` panels, `#202122` widgets) with OrangeBox syntax colors and orange accents

### Changed

- Replaced orange-tinted active/selection backgrounds across Dark, Dark Ultra, and Dark Plus themes with neutral alternatives:
  - **Dark**: warm mid-grey selections (`#3c3c3c`, `#4d4d4d80`)
  - **Dark Plus**: Dark 2026 blue-teal selections (`#3994BC26`, `#276782dd`)
  - **Dark Ultra**: deep cool-grey selections (`#272727`, `#3a3a3a80`)
- Updated menu, scrollbar, terminal, peek view, and status bar active backgrounds to remove orange tint across all dark themes
